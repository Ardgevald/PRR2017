...
public abstract class Message {
	...
	public static enum MessageType {
		 ...
		 *
		 * Lorsque l'ElectionManager reçoit un ECHO, il le quittance. Le client
	 ...
	 * Un message de type echo permet de vérifier si l'élu est toujours up.
	 *
	 * Lorsque l'ElectionManager reçoit un ECHO, il le quittance. Le client ayant
	...
	public static class EchoMessage extends Message {
		 ...
		 * Permet de connaitre le type du message courant
		 *
		 * @return un type de message ECHO
		 */
		@Override
		protected MessageType getMessageType() {
